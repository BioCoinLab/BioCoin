...
const Footer = () => {
  ...
  return (
    <footer className={`${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-800'} text-white transition-colors`}>
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">Email: info@biocoin.vip</p>
            <p className="text-gray-400">Address: 123 Blockchain Ave, Bio City, 94101</p>
          </div>
        </div>
